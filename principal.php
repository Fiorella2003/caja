...
<head>
  ...
  <link rel="icon" type="image/png" href="imagen/iconos/logo_1.ico" />
  ...
  <div class="wrapper">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <a href="index.php" class="btn btn-danger dropdown-footer">Cerrar Sesión</a>
          </div>
        </li>
    ...
    <aside class="main-sidebar sidebar-light-primary elevation-4">
      ...
      <a href="principal.php" class="brand-link">
        <img src="imagen/logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-2" style="opacity: .8">
        <span class="brand-text font-weight-light">TESORERÍA</span>
      </a>
